; Rescue Raiders selector-1 transition entry, mechanically decoded and
; source-exact. Semantic labels remain intentionally conservative.
...
L69F6:  lda     $60BC                           ; 69F6 AD BC 60                 ..`
        ; Both branch targets lie in the continuation loaded outside this
        ; one-page source artifact, so retain their exact relative encodings.
        .byte   $d0,$3e                         ; 69F9 BNE $6A39
        lda     $60C6                           ; 69FB AD C6 60                 ..`
        .byte   $f0,$1a                         ; 69FE BEQ $6A1A
